        ...
        switch (tag) {
          ...
          case 34: {
            if (!((mutable_bitField0_ & 0x00000008) != 0)) {
              staticHosts_ = new java.util.ArrayList<com.v2ray.core.app.dns.Config.HostMapping>();
              mutable_bitField0_ |= 0x00000008;
            }
            staticHosts_.add(
                input.readMessage(com.v2ray.core.app.dns.Config.HostMapping.parser(), extensionRegistry));
            break;
          }
          case 42: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              nameServer_ = new java.util.ArrayList<com.v2ray.core.app.dns.NameServer>();
              mutable_bitField0_ |= 0x00000002;
            }
            nameServer_.add(
                input.readMessage(com.v2ray.core.app.dns.NameServer.parser(), extensionRegistry));
            break;
          }
          case 50: {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.v2ray.core.app.dns.Config.HostMapping parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.v2ray.core.app.dns.Config.HostMapping) e.getUnfinishedMessage();

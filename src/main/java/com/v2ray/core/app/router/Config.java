        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              balancingRule_ = new java.util.ArrayList<com.v2ray.core.app.router.BalancingRule>();
              mutable_bitField0_ |= 0x00000002;
            }
            balancingRule_.add(
                input.readMessage(com.v2ray.core.app.router.BalancingRule.parser(), extensionRegistry));
            break;
          }
          default: {

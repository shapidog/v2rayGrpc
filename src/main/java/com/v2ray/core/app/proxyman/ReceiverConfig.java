    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 66: {
            com.v2ray.core.app.proxyman.SniffingConfig.Builder subBuilder = null;
            if (sniffingSettings_ != null) {
              subBuilder = sniffingSettings_.toBuilder();
            }
            sniffingSettings_ = input.readMessage(com.v2ray.core.app.proxyman.SniffingConfig.parser(), extensionRegistry);
            if (subBuilder != null) {

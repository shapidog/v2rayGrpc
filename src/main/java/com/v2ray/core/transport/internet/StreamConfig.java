    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 50: {
            com.v2ray.core.transport.internet.SocketConfig.Builder subBuilder = null;
            if (socketSettings_ != null) {
              subBuilder = socketSettings_.toBuilder();
            }
            socketSettings_ = input.readMessage(com.v2ray.core.transport.internet.SocketConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
